...
test('RC2.2-6: 250 questions, five sessions, four mixed and one all-hard', () => {
...
test('RC2.2-6: the holdout is generated as one batch, so no instance repeats across it', () => {
...
test('RC2.2-6: the session accounting closes on the holdout itself', () => {
