...
import {DEVELOPMENT_SEEDS, RC21_DEVELOPMENT_SEEDS, RC22_DEVELOPMENT_SEEDS, RC23_DEVELOPMENT_SEEDS, RC24_DEVELOPMENT_SEEDS, RC27_DEVELOPMENT_SEEDS, RC27_SIGNOFF_SEED, RC28_DEVELOPMENT_SEEDS, RC28_SIGNOFF_SEED, RC29_DEVELOPMENT_SEEDS, RC29_SIGNOFF_SEED, RC291_DEVELOPMENT_SEEDS, RC291_SIGNOFF_SEED, RC26_HOLDOUT_SEED, HOLDOUT_SEED} from './rc2-development-corpus.mjs';
...
export function freeze() {
  ...
  const rc291 = existsSync('rc2/RC291_DEVELOPMENT_CORPUS.json');
  const rc29 = !rc291 && existsSync('rc2/RC29_DEVELOPMENT_CORPUS.json');
  const rc28 = !rc291 && !rc29 && existsSync('rc2/RC28_DEVELOPMENT_CORPUS.json');
  const rc27 = !rc291 && !rc29 && !rc28 && existsSync('rc2/RC27_DEVELOPMENT_CORPUS.json');
  const rc24 = !rc291 && !rc29 && !rc28 && !rc27 && existsSync('rc2/RC24_DEVELOPMENT_CORPUS.json');
  ...
  const corpusPath = rc291 ? 'rc2/RC291_DEVELOPMENT_CORPUS.json'
  ...
  const corpusGzPath = rc291 ? 'rc2/rc291-development-corpus.jsonl.gz'
  ...
  return {
    ...
    release: rc291 ? 'RC2.9.1' : rc29 ? 'RC2.9' : rc28 ? 'RC2.8' : rc27 ? 'RC2.7' : rc24 ? 'RC2.4' : rc23 ? 'RC2.3' : rc22 ? 'RC2.2' : rc21 ? 'RC2.1' : 'RC2',
    developmentSeeds: [...(rc291 ? RC291_DEVELOPMENT_SEEDS : rc29 ? RC29_DEVELOPMENT_SEEDS : rc28 ? RC28_DEVELOPMENT_SEEDS : rc27 ? RC27_DEVELOPMENT_SEEDS : rc24 ? RC24_DEVELOPMENT_SEEDS : rc23 ? RC23_DEVELOPMENT_SEEDS : rc22 ? RC22_DEVELOPMENT_SEEDS : rc21 ? RC21_DEVELOPMENT_SEEDS : DEVELOPMENT_SEEDS)],
    ...
    holdoutSeed: rc291 ? RC291_SIGNOFF_SEED : rc29 ? RC29_SIGNOFF_SEED : rc28 ? RC28_SIGNOFF_SEED : rc27 ? RC27_SIGNOFF_SEED : (rc24 || rc23) ? RC23_SIGNOFF_SEED : rc22 ? RC22_HOLDOUT_SEED : rc21 ? RC21_HOLDOUT_SEED : HOLDOUT_SEED,
    ...
    previousHoldouts: (rc291 || rc29 || rc28 || rc27)
      ? [{seed: HOLDOUT_SEED, status: 'FAILED_DIAGNOSTIC_HOLDOUT', reused: false},
         ...
         ...(rc291 ? [{seed: RC29_SIGNOFF_SEED, status: 'FROZEN_AGAINST_AND_SPENT', reused: false}] : [])]
      : (rc24 || rc23)
      ? [{seed: HOLDOUT_SEED, status: 'FAILED_DIAGNOSTIC_HOLDOUT', reused: false},
         {seed: RC21_HOLDOUT_SEED, status: 'REVIEWED_AND_SPENT', reused: false},
         {seed: RC22_HOLDOUT_SEED, status: 'REVIEWED_AND_SPENT', reused: false}]
