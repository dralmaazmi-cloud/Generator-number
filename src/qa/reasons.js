...
export const REASON = Object.freeze({
  ...
  RATIONALE_INCONSISTENT: 'RATIONALE_INCONSISTENT',
  ...
  // RC2.9.6 §3.1. Numbers a learner would have to copy rather than read.
  AWKWARD_DECIMAL_ANSWER: 'AWKWARD_DECIMAL_ANSWER',
  NON_INTEGER_ANSWER_IN_WHOLE_FAMILY: 'NON_INTEGER_ANSWER_IN_WHOLE_FAMILY',
