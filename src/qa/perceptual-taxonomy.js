...
export const TASK_BY_TARGET = Object.freeze({
  ...
  ratioPartCount: t('DECOMPOSE_COMBINED', 'COUNT'),
  fasterSpeed: t('COMPARE_ALTERNATIVES', 'SPEED'),
  daysUntilDay: t('MEASURE_INTERVAL', 'COUNT'),
  countBelowInChain: t('COUNT_SATISFYING', 'COUNT'),
  firstTermAboveBound: t('FIND_THRESHOLD', 'TERM'),
  ageGapNow: t('COMPARE_ALTERNATIVES', 'AGE'),
  totalOfTwoMachineTypes: t('COMBINE_PARTS', 'QUANTITY'),
  unitValueOnly: t('DECOMPOSE_COMBINED', 'MONEY'),
  totalOfTwoItems: t('COMBINE_PARTS', 'MONEY'),
  remainingPercent: t('FIND_REMAINDER', 'PERCENT'),
  dailyRateFromTotal: t('DECOMPOSE_COMBINED', 'RATE'),
  rangeOfValues: t('COMPARE_ALTERNATIVES', 'QUANTITY'),
  countMatchingRule: t('COUNT_SATISFYING', 'COUNT'),
  lostOutputWhileStopped: t('FIND_REMAINDER', 'QUANTITY'),
  sumOfAgesAfterYears: t('COMBINE_PARTS', 'AGE'),
  sumOfShownTerms: t('COMBINE_PARTS', 'NUMBER'),
  impossibleStatementInChain: t('JUDGE_INDETERMINACY', 'STATEMENT'),
  dayBeforeOffset: t('REVERSE_RECOVER', 'DATE'),
  remainingDistance: t('FIND_REMAINDER', 'DISTANCE'),
  twoLegDistance: t('COMBINE_PARTS', 'DISTANCE'),
  ratioShareGap: t('DECOMPOSE_COMBINED', 'QUANTITY'),
  ratioCommonFactor: t('IDENTIFY_RULE', 'NUMBER'),
...
export const INFO_STRUCTURE_BY_TEMPLATE = Object.freeze({
  ...
  PROP_E_UNIT_VALUE: 'GIVENS_LISTED_THEN_ASK',
  PROP_E_TOTAL_TWO_ITEMS: 'TWO_CONFIGURATIONS',
  PCT_E_REMAINING_PERCENT: 'REMAINDER_AFTER_PARTS',
  WORK_E_RATE_FROM_TOTAL: 'CONTEXT_THEN_NUMBERS',
  AVG_E_RANGE: 'VALUE_LIST',
  ODD_E_COUNT_MATCHING: 'SET_DISPLAY',
  MACH_E_TOTAL_TWO_TYPES: 'TWO_CONFIGURATIONS',
  MACH_E_LOST_OUTPUT: 'TWO_CONFIGURATIONS',
  AGE_E_GAP: 'DIRECT_GIVENS',
  AGE_E_TOTAL_AFTER: 'RELATION_AT_TWO_TIMES',
  SEQ_E_FIRST_ABOVE: 'RUN_CONSTANT_DIFFERENCE',
  SEQ_E_SUM_SHOWN: 'VALUE_LIST',
  REL_E_COUNT_BELOW: 'RELATIONAL_STATEMENTS',
  REL_E_FALSE_STATEMENT: 'RELATIONAL_STATEMENTS',
  CAL_E_DAYS_BETWEEN: 'TWO_ENDPOINTS',
  CAL_E_BEFORE: 'CALENDAR_BACKWARD',
  SPD_E_COMPARE: 'TWO_CONFIGURATIONS',
  SPD_E_REMAINING: 'REMAINDER_AFTER_PARTS',
  SPD_E_TOTAL_TRIP: 'CONTEXT_THEN_NUMBERS',
  RAT_E_PART_COUNT: 'PARTITION_OF_WHOLE',
  RAT_E_SHARE_GAP: 'PARTITION_OF_WHOLE',
  RAT_E_COMMON_FACTOR: 'DIRECT_GIVENS',
