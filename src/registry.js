...
export const FAMILY_REGISTRY = [
  ...
  {id:'ages', ar:'مسائل الأعمار', category:'مسائل الأعمار', templates:['AGE_E_SUM_DIFF', 'AGE_E_MULT_DIFF', 'AGE_M_FUT_SUM_DIFF', 'AGE_M_RATIO_FUT_SUM', 'AGE_M_FUT_RATIO', 'AGE_H_TWO_TIME', 'AGE_H_PAST_FUT', 'AGE_M_WHEN_RATIO', 'AGE_H_THREE_SIBLINGS'], description:'مجموع وفرق، نسب عمرية، ماضٍ ومستقبل.'},
