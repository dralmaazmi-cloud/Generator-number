...
export const FAMILY_REGISTRY = [
  ...
  {id:'odd_one_out', ar:'العدد الذي لا ينتمي', category:'العدد الذي لا ينتمي إلى المجموعة', templates:['ODD_E_MULT', 'ODD_E_SQUARES', 'ODD_M_PRONIC', 'ODD_M_PRIME2', 'ODD_M_CUBES', 'ODD_H_SQ_MINUS', 'ODD_H_TRIANGULAR', 'ODD_M_PROPERTY', 'ODD_M_EXTEND', 'ODD_E_PROPERTY', 'ODD_E_EXTEND'], description:'مضاعفات، مربعات، مكعبات، أوليات، خصائص عددية، وتسمية الخاصية المشتركة أو ضمّ عدد إليها.'},
