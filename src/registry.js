...
export const FAMILY_REGISTRY = [
  ...
  {id:'averages', ar:'المتوسط الحسابي', category:'المتوسط الحسابي', templates:['AVG_E_ADD', 'AVG_E_REMOVE', 'AVG_M_COMBINE', 'AVG_M_ADD_PAIR', 'AVG_M_REPLACE', 'AVG_H_COMB_ADD', 'AVG_H_TARGET', 'AVG_H_OVERLAP', 'AVG_H_SPLIT_SIZE', 'AVG_E_LIST', 'AVG_E_MISSING_VALUE'], description:'إضافة، حذف، استبدال، دمج مجموعات.'},
  {id:'ages', ar:'مسائل الأعمار', category:'مسائل الأعمار', templates:['AGE_E_SUM_DIFF', 'AGE_E_MULT_DIFF', 'AGE_M_FUT_SUM_DIFF', 'AGE_M_RATIO_FUT_SUM', 'AGE_M_FUT_RATIO', 'AGE_H_TWO_TIME', 'AGE_H_PAST_FUT', 'AGE_M_WHEN_RATIO', 'AGE_H_THREE_SIBLINGS', 'AGE_M_PAST_RATIO', 'AGE_M_DIFFERENCE_INVARIANT', 'AGE_E_RATIO_SUM', 'AGE_E_TIME_SHIFT', 'AGE_E_YEARS_TO_SUM'], description:'مجموع وفرق، نسب عمرية، ماضٍ ومستقبل، ونسبة في الماضي أو فرق ثابت بين زمنين.'},
  {id:'speed', ar:'السرعة والمسافة والزمن', category:'السرعة والمسافة والزمن', templates:['SPD_E_DISTANCE', 'SPD_E_TIME', 'SPD_M_AVG', 'SPD_M_TWO_TIME', 'SPD_H_CATCH', 'SPD_H_MEET_DELAY', 'SPD_M_EQUAL_DIST', 'SPD_H_TIME_DIFF', 'SPD_H_CURRENT', 'SPD_H_LEG_SPLIT', 'SPD_E_SPEED', 'SPD_E_UNIT_MINUTES', 'SPD_E_SAME_DIRECTION_GAP'], description:'مراحل، متوسط سرعة، التقاء، لحاق، فرق زمن.'},
  ...
  {id:'machines', ar:'الآلات والإنتاج', category:'الآلات والإنتاج', templates:['MACH_E_HOURS', 'MACH_E_REQUIRED', 'MACH_M_STOP', 'MACH_M_NEW_FAST', 'MACH_M_SUBSET_UP', 'MACH_H_TWO_TYPES', 'MACH_H_STAGE_UP', 'MACH_H_TWO_CONFIG', 'MACH_H_STOPPAGE_TIME', 'MACH_H_MIN_SECOND_TYPE', 'MACH_E_RATE_FROM_TOTAL', 'MACH_E_TIME_FOR_TARGET', 'MACH_E_COMPARE'], description:'آلة-ساعة، توقف آلة، تغير الإنتاجية، عدد الآلات.'},
  {id:'direct_proportion', ar:'التناسب المباشر', category:'التناسب المباشر البسيط', templates:['PROP_E_ITEMS', 'PROP_E_COST', 'PROP_M_FRAC_UNIT', 'PROP_M_RECIPE', 'PROP_M_MAP', 'PROP_H_COMPOUND', 'PROP_H_COST_PLUS', 'PROP_H_TWO_ITEM_SYSTEM', 'PROP_H_REPLACE', 'PROP_H_CAPITAL_TIME', 'PROP_H_BREAK_EVEN', 'PROP_M_UNIT_PRICE_COMPARE', 'PROP_M_SCALE_ACROSS_HOURS'], description:'تكلفة، وزن، وصفة، مقياس، عدد وحدات.'},
  {id:'fractions', ar:'الكسور المتتابعة', category:'الكسور المتتابعة المباشرة', templates:['FRAC_E_2', 'FRAC_M_3', 'FRAC_H_4', 'FRAC_M_REMAIN', 'FRAC_M_REMAIN_VALUE', 'FRAC_M_START_FROM_REMAINDER', 'FRAC_M_COMPARE_SHARES'], description:'كسور مباشرة متتابعة من عدد معلوم، والباقي بعد إنفاق كسرين.'},
  {id:'unit_rate', ar:'المعدل الوحدوي', category:'المعدل الوحدوي', templates:['RATE_E_DIRECT', 'RATE_E_TIME', 'RATE_M_SCALE', 'RATE_M_PERCENT', 'RATE_H_TARGET', 'RATE_H_TWO_PHASE', 'RATE_H_RATE_FROM_GAP', 'RATE_M_COMPARE', 'RATE_M_HOURS_FROM_MINUTE_RATE'], description:'كمية لكل وحدة ثم توسع أو تغير في المعدل.'},
  ...
  {id:'relational', ar:'المقارنة والترتيب العلاقاتي', category:'المقارنة والترتيب العلاقاتي', templates:['REL_E_BETWEEN', 'REL_E_CHAIN', 'REL_M_CHAIN6', 'REL_M_CONFIRM', 'REL_M_BRANCH_UNRES', 'REL_M_COUNT', 'REL_H_COUNT_BRANCHED', 'REL_H_POSITION', 'REL_H_GUARANTEE', 'REL_E_STATEMENT_TRUE', 'REL_E_GAP_CHAIN'], description:'ترتيب كامل، فروع، علاقة غير محسومة، عبارة مؤكدة.'},
  {id:'calendar', ar:'الاستدلال الزمني وأيام الأسبوع', category:'الاستدلال الزمني وأيام الأسبوع', templates:['CAL_E_TOM', 'CAL_E_AFTER', 'CAL_M_COMPOUND', 'CAL_M_TWO_SHIFT', 'CAL_H_LONG', 'CAL_H_NESTED', 'CAL_H_CYCLE_MEET', 'CAL_H_MONTH_LENGTH', 'CAL_H_OFFSET_CYCLES', 'CAL_M_DATE_WEEKDAY', 'CAL_M_NTH_VISIT'], description:'أمس وغد وبعد غد وتحولات زمنية مركبة.'},
  {id:'odd_one_out', ar:'العدد الذي لا ينتمي', category:'العدد الذي لا ينتمي إلى المجموعة', templates:['ODD_E_MULT', 'ODD_E_SQUARES', 'ODD_M_PRONIC', 'ODD_M_PRIME2', 'ODD_M_CUBES', 'ODD_H_SQ_MINUS', 'ODD_H_TRIANGULAR', 'ODD_M_PROPERTY', 'ODD_M_EXTEND'], description:'مضاعفات، مربعات، مكعبات، أوليات، خصائص عددية، وتسمية الخاصية المشتركة أو ضمّ عدد إليها.'},
