...
export const FAMILY_REGISTRY = [
  ...
  {id:'work_time', ar:'العمال والزمن', category:'العمال والزمن', templates:['WORK_E_VOLUME', 'WORK_E_INVERSE', 'WORK_M_EFF', 'WORK_M_TARGET', 'WORK_M_CHANGE', 'WORK_H_TWO_STAGE', 'WORK_H_WORKERS_EFF', 'WORK_H_JOINT_SOLO', 'WORK_H_EXTRA_WORKERS'], description:'عامل-يوم، تغير عدد العمال، كفاءة وحجم عمل.'},
  ...
  {id:'direct_proportion', ar:'التناسب المباشر', category:'التناسب المباشر البسيط', templates:['PROP_E_ITEMS', 'PROP_E_COST', 'PROP_M_FRAC_UNIT', 'PROP_M_RECIPE', 'PROP_M_MAP', 'PROP_H_COMPOUND', 'PROP_H_COST_PLUS', 'PROP_H_TWO_ITEM_SYSTEM'], description:'تكلفة، وزن، وصفة، مقياس، عدد وحدات.'},
  ...
  {id:'relational', ar:'المقارنة والترتيب العلاقاتي', category:'المقارنة والترتيب العلاقاتي', templates:['REL_E_BETWEEN', 'REL_E_CHAIN', 'REL_M_CONFIRM', 'REL_M_BRANCH_UNRES', 'REL_M_COUNT', 'REL_H_COUNT_BRANCHED', 'REL_H_POSITION', 'REL_H_GUARANTEE'], description:'ترتيب كامل، فروع، علاقة غير محسومة، عبارة مؤكدة.'},
  {id:'calendar', ar:'الاستدلال الزمني وأيام الأسبوع', category:'الاستدلال الزمني وأيام الأسبوع', templates:['CAL_E_TOM', 'CAL_E_AFTER', 'CAL_M_COMPOUND', 'CAL_M_TWO_SHIFT', 'CAL_H_LONG', 'CAL_H_NESTED', 'CAL_H_CYCLE_MEET'], description:'أمس وغد وبعد غد وتحولات زمنية مركبة.'},
  ...
  {id:'profit_loss', ar:'الربح والخسارة والأسعار', category:'الربح والخسارة والأسعار', templates:['PL_E_PROFIT', 'PL_E_LOSS', 'PL_H_REVERSE', 'PL_M_TOTAL_COST', 'PL_M_DISC_MARK', 'PL_H_CHAIN', 'PL_H_TWO_OUTCOMES', 'PL_H_MARKUP_DISCOUNT'], description:'تكلفة، ربح، خسارة، خصم، سعر بيع، تكلفة كلية.'}
];
