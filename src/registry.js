...
export const FAMILY_REGISTRY = [
  {id:'sequences', ar:'المتتاليات العددية', category:'المتتاليات العددية', templates:['SEQ_E_GEO', 'SEQ_E_ARITH', 'SEQ_M_INTERLEAVED', 'SEQ_M_INC_DIFF', 'SEQ_M_ALT_OPS', 'SEQ_M_DOUBLE_DIFF', 'SEQ_H_RECURRENCE', 'SEQ_H_POW_INDEX', 'SEQ_H_ALT_DIV', 'SEQ_H_DIGIT_SUM', 'SEQ_H_INDEX_MULT', 'SEQ_M_LINEAR_RECUR', 'SEQ_M_CYCLE3', 'SEQ_M_PAIR_RULE', 'SEQ_H_DIGIT_PRODUCT', 'SEQ_M_WRONG_TERM', 'SEQ_M_RULE_ID', 'SEQ_M_RULE_APPLY', 'SEQ_M_MISSING_OP', 'SEQ_M_CANDIDATE'], description:'فروق، ضرب وقسمة، تناوب، دورات عمليات، سلاسل متداخلة، حدود مزدوجة، قواعد من الأرقام، وحد مخالف، وتسمية القاعدة أو تطبيقها.'},
  {id:'ratios', ar:'النسب وتقسيم الكميات', category:'النسب وتقسيم الكميات', templates:['RAT_E_KNOWN', 'RAT_E_SPLIT', 'RAT_M_COMMON_SUM', 'RAT_M_COMMON_DIFF', 'RAT_H_TWO_COMB', 'RAT_M_ADD_SIDE', 'RAT_H_TRANSFER', 'RAT_H_MAX_PART'], description:'توحيد النسب، مجموع وفرق، تغير النسبة، نقل كميات.'},
  ...
  {id:'machines', ar:'الآلات والإنتاج', category:'الآلات والإنتاج', templates:['MACH_E_HOURS', 'MACH_E_REQUIRED', 'MACH_M_STOP', 'MACH_M_NEW_FAST', 'MACH_M_SUBSET_UP', 'MACH_H_TWO_TYPES', 'MACH_H_STAGE_UP', 'MACH_H_TWO_CONFIG', 'MACH_H_STOPPAGE_TIME', 'MACH_H_MIN_SECOND_TYPE'], description:'آلة-ساعة، توقف آلة، تغير الإنتاجية، عدد الآلات.'},
  {id:'direct_proportion', ar:'التناسب المباشر', category:'التناسب المباشر البسيط', templates:['PROP_E_ITEMS', 'PROP_E_COST', 'PROP_M_FRAC_UNIT', 'PROP_M_RECIPE', 'PROP_M_MAP', 'PROP_H_COMPOUND', 'PROP_H_COST_PLUS', 'PROP_H_TWO_ITEM_SYSTEM', 'PROP_H_REPLACE', 'PROP_H_CAPITAL_TIME', 'PROP_H_BREAK_EVEN'], description:'تكلفة، وزن، وصفة، مقياس، عدد وحدات.'},
  {id:'fractions', ar:'الكسور المتتابعة', category:'الكسور المتتابعة المباشرة', templates:['FRAC_E_2', 'FRAC_M_3', 'FRAC_H_4', 'FRAC_M_REMAIN'], description:'كسور مباشرة متتابعة من عدد معلوم، والباقي بعد إنفاق كسرين.'},
